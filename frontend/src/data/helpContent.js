export const HELP_CONTENT = {
  ...
  customers: {
    ...
    how_to: [
      ...
      ["Edit customer", "Select a row, click Edit or Ctrl+O."],
      ["Delete customer", "Select row, Delete key or trash button."],
    ],
    shortcuts: [
      ["F1", "Help"],
      ["F8", "Record leave / holiday (Calendar)"],
      ["Ctrl+N", "New"],
      ["Ctrl+O", "Edit"],
      ["Ctrl+S", "Save form"],
  ...
  settings: {
    ...
    how_to: [
      ["Manual export", "Ctrl+Shift+X or Export button → JSON daily summary."],
      ["Nightly backup", "Runs automatically at 10:00 PM via APScheduler."],
    ],
    shortcuts: [
      ["F10", "Save snapshot"],
      ["Ctrl+Shift+X", "Extract / export JSON"],
    ],
    faq: [],
  },
};
